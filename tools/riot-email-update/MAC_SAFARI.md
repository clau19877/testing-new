...
## Cloudflare / warm-up (BUILD 2026-08-09v+)
...
the latest zip (**BUILD 2026-08-09v** or newer) — those names are reserved in
AppleScript.
...
**BUILD 2026-08-09v+** hard-kills the whole tree: `run_safari_batch.py`,
