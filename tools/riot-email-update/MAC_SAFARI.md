...
## Cloudflare / warm-up (BUILD 2026-08-12m+)
...
the latest zip (**BUILD 2026-08-12m** or newer) — those names are reserved in
AppleScript.
...
By default (**BUILD 2026-08-12m+**) the script does **not** bring Safari to the
