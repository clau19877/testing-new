...
## Cloudflare / warm-up (BUILD 2026-08-12p+)
...
the latest zip (**BUILD 2026-08-12p** or newer) — those names are reserved in
AppleScript.
...
By default (**BUILD 2026-08-12p+**) the script does **not** bring Safari to the
