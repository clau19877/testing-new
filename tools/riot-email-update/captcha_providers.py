...
Preferred for Riot hCaptcha (in-bot, not AYCD/token hub):
  - CAPTCHA_PROVIDER=manual  — human solves in the live browser
  - CAPTCHA_PROVIDER=vision  — in-browser OCR/AI + 2Captcha Coordinates clicks
